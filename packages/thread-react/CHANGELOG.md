...
- Updated dependencies [bbe761a]
  - @kiri_ikki/thread-client@2.0.0
...
- Updated dependencies [fa1b5ab]
  - @kiri_ikki/thread-client@1.0.0

## 0.1.1

### Patch Changes

- Updated dependencies [fad579b]
  - @kiri_ikki/thread-client@0.1.1

## 0.1.0

### Minor Changes

- 3916ff3: Publish the initial self-hosted thread contracts, HTTP client, and React integration.

### Patch Changes

- Updated dependencies [3916ff3]
  - @kiri_ikki/thread-client@0.1.0
